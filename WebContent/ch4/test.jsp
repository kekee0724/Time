...
<body bgcolor="#FA897B">
	<%=request.getParameter("username")%>，欢迎您！<br><br>
	进入在线测试系统，请遵守规则。<br><br>
	<form action="ch4/result.jsp" method="post">
		...
		1. 以下可以用来编辑java的编辑器是： <br> A<input type="checkbox" name="name_3"
			...
			value="B">EXCEL<br> C<input type="checkbox" name="name_3"
			value="C">记事本<br> D<input type="checkbox" name="name_3"
			value="D">PowerPoint<br> <br></br> <br></br>
